...
class UIManager {
  ...
  createOtherMessageContent(message) {
    ...
    avatar.className = 'w-10 h-10 rounded-full bg-surface-lighter shrink-0 mt-1 flex items-center justify-center';
  ...
  createMessageActions(messageId, content, messageType = 'text') {
    ...
    if (!isOwnMessage) {
      return actionsDiv; // Return empty div for other users' messages
    }
