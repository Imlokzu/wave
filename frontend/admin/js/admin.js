...
fetch(`${window.API_URL}/api/auth/session', {
    headers: {
        'Authorization': `Bearer ${token}`
    }
})
...
async function loadUsers(page = 1) {
    try {
        ...
        const response = await fetch(`${window.API_URL}/api/admin/users?${params}`, {
            headers: {
                'Authorization': `Bearer ${token}`
            }
        });
...
async function togglePro(userId, isPro) {
    try {
        const response = await fetch(`${window.API_URL}/api/admin/users/${userId}/pro`, {
            method: 'PATCH',
            headers: {
                'Authorization': `Bearer ${token}`,
...
async function toggleAdmin(userId, isAdmin) {
    ...
    try {
        const response = await fetch(`${window.API_URL}/api/admin/users/${userId}/admin`, {
            method: 'PATCH',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
...
async function loadBugReports() {
    try {
        const response = await fetch(`${window.API_URL}/api/admin/reports/bugs', {
...
async function updateBugReport(reportId, status) {
    try {
        const response = await fetch(`${window.API_URL}/api/admin/reports/bugs/${reportId}`, {
            method: 'PATCH',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
...
async function loadProRequests() {
    try {
        const response = await fetch(`${window.API_URL}/api/admin/requests/pro', {
            headers: { 'Authorization': `Bearer ${token}` }
        });
...
async function processProRequest(requestId, status) {
    try {
        const response = await fetch(`${window.API_URL}/api/admin/requests/pro/${requestId}`, {
            method: 'PATCH',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
...
async function loadScamReports() {
    try {
        const response = await fetch(`${window.API_URL}/api/admin/reports/scam', {
            headers: { 'Authorization': `Bearer ${token}` }
        });
...
async function updateScamReport(reportId, status) {
    try {
        const response = await fetch(`${window.API_URL}/api/admin/reports/scam/${reportId}`, {
            method: 'PATCH',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
...
async function loadBans() {
    try {
        const response = await fetch(`${window.API_URL}/api/admin/bans', {
            headers: { 'Authorization': `Bearer ${token}` }
        });
...
async function confirmBan() {
    ...
    try {
        const response = await fetch(`${window.API_URL}/api/admin/users/${banUserId}/ban`, {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
...
async function unbanUser(userId) {
    ...
    try {
        const response = await fetch(`${window.API_URL}/api/admin/users/${userId}/unban`, {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token}`
            }
